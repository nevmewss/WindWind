...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const CHAT_ID = "-1003297159749"; // твой chat_id
    ...
    form.addEventListener("submit", async (e) => {
        ...
        let message = `<b>🧮 Нова заявка з квізу</b>\n\n`;
        ...
        function showThankYou() {
            document.querySelector(".page__quiz")?.classList.add("done");
            document.querySelector(".page__hero")?.classList.add("done");

            const thxSection = document.querySelector(".page__thx");
            if (thxSection) {
                thxSection.classList.add("visible");
                thxSection.scrollIntoView({ behavior: "smooth" });
            }
        }
        ...
        try {
            ...
            console.error(err);
            alert("⚠️ Не вдалося з’єднатися з Telegram API.");
        }
    });
});
